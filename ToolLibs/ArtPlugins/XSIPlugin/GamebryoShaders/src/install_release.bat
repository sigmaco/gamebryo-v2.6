...
rem copy "%EGB_PATH%\ToolLibs\ArtPlugins\XSIPlugin\Win32\VC80\ReleaseDLL\GamebryoShaders\GamebryoShaders.dll" "%XSISDK_ROOT%\..\Application\Plugins\"
copy "%EGB_PATH%\ToolLibs\ArtPlugins\XSIPlugin\Win32\VC80\ReleaseDLL\GamebryoShaders\GamebryoShaders.dll" "%XSISDK_ROOT%\..\Application\bin\"
